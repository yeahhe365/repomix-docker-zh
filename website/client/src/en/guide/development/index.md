...
To build the website and point the generated frontend at a local API server:
...
To run the packaged frontend and backend with Docker:

```bash
cd website/client
VITE_REPOMIX_API_BASE_URL=http://localhost:5173 npm run docs:build
